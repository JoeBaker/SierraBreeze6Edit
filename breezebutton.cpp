    ...
    Button *Button::create(DecorationButtonType type, KDecoration2::Decoration *decoration, QObject *parent)
    {
        if (auto d = qobject_cast<Decoration *>(decoration))
        {
            ...
            switch (type)
            {
                ...
                case DecorationButtonType::Menu: QObject::connect(d->client(), &KDecoration2::DecoratedClient::iconChanged, b, [b]() { b->update(); }); break;
            ...
            switch (type())
            {
                ...
                case DecorationButtonType::Shade:
                {
                    ...
                    if (isChecked())
                    {
                        ...
                        painter->drawPolyline(QPolygonF() << QPointF(4, 8) << QPointF(9, 13) << QPointF(14, 8));
                    }
                    else if (isHovered())
                    {
                        painter->setPen(hint_pen);
                        painter->drawLine(4, 5, 14, 5);
                        painter->drawPolyline(QPolygonF() << QPointF(4, 13) << QPointF(9, 8) << QPointF(14, 13));
                    }
                    break;
                }
