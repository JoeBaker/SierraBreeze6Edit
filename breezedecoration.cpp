...
namespace SierraBreeze
{
    ...
    //________________________________________________________________
    Decoration::Decoration(QObject *parent, const QVariantList &args) : KDecoration2::Decoration(parent, args), m_animation(new QPropertyAnimation(this))
    {
        g_sDecoCount++;
    }
    ...
    void Decoration::paintTitleBar(QPainter *painter, const QRect &repaintRegion)
    {
        ...
        else
        {
            ...
            painter->drawRoundedRect(titleRect.adjusted(isLeftEdge() ? -Metrics::Frame_FrameRadius : 0, isTopEdge() ? -Metrics::Frame_FrameRadius : 0,
                                                        isRightEdge() ? Metrics::Frame_FrameRadius : 0, Metrics::Frame_FrameRadius),
    ...
    QPair<QRect, Qt::Alignment> Decoration::captionRect() const
    {
        ...
        else
        {
            ...
            {
                case InternalSettings::AlignLeft: return qMakePair(maxRect, Qt::AlignVCenter | Qt::AlignLeft);

                case InternalSettings::AlignRight: return qMakePair(maxRect, Qt::AlignVCenter | Qt::AlignRight);

                case InternalSettings::AlignCenter: return qMakePair(maxRect, Qt::AlignCenter);
    ...
    void Decoration::createShadow()
    {
            ...
            g_shadowColor != m_internalSettings->shadowColor())
        {
            ...
            // contrast pixel
            QRectF innerRect = QRectF(g_shadowSize - Metrics::Shadow_Overlap, g_shadowSize - shadowOffset - Metrics::Shadow_Overlap, 2 * Metrics::Shadow_Overlap,
            ...
            g_sShadow->setPadding(QMargins(
                ...
                g_shadowSize - Metrics::Shadow_Overlap, g_shadowSize - shadowOffset - Metrics::Shadow_Overlap, g_shadowSize - Metrics::Shadow_Overlap,
